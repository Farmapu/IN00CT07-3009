package com.example.viikkokolme
...
import com.example.viikkokolme.ui.theme.ViikkoKolmeTheme
...
@Composable
fun Calorie( modifier: Modifier = Modifier) {
    var weightInput by remember { mutableStateOf("") }
    val weight = weightInput.toIntOrNull() ?: 0
    var male by remember { mutableStateOf(true) }
    var intenstiy by remember { mutableStateOf(1.3f) }
    ...
    Column (
        ...
        IntensityList (onClick={ intenstiy = it })
        Text(
