...
fun HeartRateLimits(modifier: Modifier = Modifier) {
    ...
    var upper = if(age > 0) (220 - age) * 0.85f else 0.0f
    var lower = if(age > 0) (220 - age) * 0.65f else 0.0f
    var upperFormatted = String.format("%.2f",upper)
    var lowerFormatted = String.format("%.2f",lower)
    Column (
